...
// Category info - moved outside component to prevent recreation on every render
const CATEGORY_INFO: Record<Category, { emoji: string; label: string; color: string; bg: string; border: string; text: string }> = {
  ...
  stocks: { emoji: "📈", label: "Stocks", color: "#0891b2", bg: "bg-cyan-50", border: "border-cyan-200", text: "text-cyan-800" },
  crypto: { emoji: "₿", label: "Crypto", color: "#2563eb", bg: "bg-blue-50", border: "border-blue-200", text: "text-blue-800" },
  technology: { emoji: "💻", label: "Technology", color: "#4f46e5", bg: "bg-indigo-50", border: "border-indigo-200", text: "text-indigo-800" },
  ai: { emoji: "🤖", label: "AI", color: "#a855f7", bg: "bg-purple-50", border: "border-purple-200", text: "text-purple-800" },
  ...
  gaming: { emoji: "🎮", label: "Gaming", color: "#8b5cf6", bg: "bg-violet-50", border: "border-violet-200", text: "text-violet-800" },
  science: { emoji: "🔬", label: "Science", color: "#0d9488", bg: "bg-teal-50", border: "border-teal-200", text: "text-teal-800" },
  climate: { emoji: "🌡️", label: "Climate", color: "#65a30d", bg: "bg-lime-50", border: "border-lime-200", text: "text-lime-800" },
  health: { emoji: "🏥", label: "Health", color: "#dc2626", bg: "bg-rose-50", border: "border-rose-200", text: "text-rose-800" },
  society: { emoji: "👥", label: "Society", color: "#0891b2", bg: "bg-sky-50", border: "border-sky-200", text: "text-sky-800" },
